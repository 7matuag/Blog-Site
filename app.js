...
async function main(){
  await mongoose.connect("mongodb+srv://gautam7gv:IXSApR8Pc6Z0EGa4@cluster0.jajikaw.mongodb.net/blogDB");
}
...
app.get("/posts/:postId", (req, res) => {
  ...
  .then(function(postWithID){
    res.render("post", { postHeading : postWithID.title, postContent: postWithID.content });
  })
  .catch(function(err){
    console.log(err);
  });
